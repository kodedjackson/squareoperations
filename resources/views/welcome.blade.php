...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-bold text-gray-900">StaffHub</span>
                </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="slide-in">
                    <h1 class="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
                        Manage Your <span class="hero-gradient bg-clip-text text-transparent">Workforce</span> Effortlessly
                    </h1>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="dashboard.html" class="btn-primary px-8 py-3 rounded-lg font-medium text-center">Start Free Trial</a>
                        <button class="btn-secondary px-8 py-3 rounded-lg font-medium">Watch Demo</button>
                    </div>
                </div>
                <div class="float hidden md:block">
                    <div class="relative w-full h-80 bg-gradient-to-br from-orange-100 to-yellow-50 rounded-2xl shadow-2xl overflow-hidden">
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center">
                                <div class="text-6xl mb-4">👥</div>
                                <p class="text-gray-700 font-semibold">Team Operations</p>
                                <p class="text-gray-500 text-sm mt-2">Manage 500+ staff members</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="benefits" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="section-title">Why Choose StaffHub</h2>
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <div class="space-y-6">
    ...
    <section class="py-20 hero-gradient">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-orange-100 mb-8">Join hundreds of companies already using StaffHub to streamline their workflows</p>
    ...
    <footer class="bg-gray-900 text-gray-300 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        <div class="w-8 h-8 rounded-lg bg-orange-500"></div>
                        <span class="text-xl font-bold text-white">StaffHub</span>
                    </div>
            ...
            <div class="border-t border-gray-800 pt-8">
                <p class="text-center text-sm">&copy; 2025 StaffHub. All rights reserved.</p>
            </div>
        </div>
    </footer>
